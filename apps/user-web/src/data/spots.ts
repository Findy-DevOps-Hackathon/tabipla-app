...
export const SWIPE_LIMIT = 7; // 初回は3件スワイプ
export const SWIPE_LIMIT_REFINE = 5; // 追加ラウンドは9件
...
export const SWIPE_SPOTS: SwipeSpot[] = [
  ...
  },
  {
    ...
    category: "自然",
    description:
      "標高約2,000mの雄大な高原。夏は高山植物やトレッキング、早朝の雲海、夜は満天の星空が楽しめます。浅間連峰や北アルプスまで見渡す展望が魅力で、四季折々の絶景が訪れる人を魅了します。",
    trivia:
  ...
  },
  {
    ...
    category: "グルメ",
    description:
      "小諸駅前の、四季の草花に囲まれたガーデンカフェ。手入れの行き届いた庭を眺めながら、地元産の野菜や果物を生かした料理やスイーツを味わえます。旅の合間のひと休みにぴったりの癒やし空間です。",
    trivia:
  ...
  },
  {
    ...
    trivia:
      "1950年代からぶどう栽培を始めた、日本ワイン黎明期からの名門ワイナリーです。丘の上から浅間山とぶどう畑を一望でき、併設の日本庭園「万酔園」は四季折々の景観が楽しめます。",
    image: IMG_TAKAMINE,
  },
  {
    id: "s5",
    ...
    category: "グルメ",
    description:
      "盛りの良さと喉ごしで名高い信州そばの人気店。地元産そば粉のコシある手打ちそばを豊富な量で味わえます。名物「くるみそば」は香ばしい甘みが絶妙で、地元にも長く愛される郷土の味を楽しめます。",
    trivia:
      "小諸は城下町としてそば文化が根付いた土地。草笛の名物「くるみそば」は、地元のくるみをすり潰した特製ダレが名物で、新そばの季節には行列ができることもあります。",
    image: IMG_TAKAMINE_2,
  },
  {
    id: "s6",
    ...
    category: "歴史",
    description:
      "文豪・島崎藤村ゆかりの歴史ある温泉宿。名物は旬のりんごを浮かべる「初恋りんご風呂」で、ほのかな香りに包まれて名湯を満喫できます。千曲川を望む静かな環境と地元食材の料理も評判で、日帰り入浴も可能です。",
    trivia:
      "島崎藤村が小諸を訪れ、代表作『初恋』の舞台として中棚荘にも滞在しました。館内には藤村が詠んだ歌碑が残り、秋から春にかけて浮かべる「初恋りんご風呂」は小諸ならではの名物です。",
...
export const SWIPE_SPOTS_REFINE: SwipeSpot[] = [
  ...
  },
  {
    ...
    trivia:
      "善光寺参りの「牛に引かれて参る」伝説の始まりの地とされる観音堂です。断崖に張り付く朱塗りの堂は小諸八景「布引観音の断崖」としても知られ、参道の岩肌と谷の眺めが荘厳な雰囲気を醸し出します。",
    image: IMG_TAKAMINE_2,
  },
  {
    id: "s9",
